...
_ENSTA Paris, Polytechnic Institute, Paris_
...
### 2022: Multi-Robot HMI for Collaborative Reconnaissance
_ENSTA Paris, Polytechnic Institute of Paris, Paris_

* Designed and built a custom human-machine interface from scratch to operate multiple robots (UGV, UAV) simultaneously in a collaborative reconnaissance mission.
